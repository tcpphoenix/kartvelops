...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "hero.lead": "KartvelOps implements, integrates and operates the platforms businesses depend on — from CI/CD and Kubernetes to core-banking rollouts. Experienced engineers on every task, project-based delivery, nothing you don't need.",
      "hero.cta1": "Discuss your project",
      "hero.cta2": "See services",
      "status.available": "available for new projects",
      "trust.1": "Senior expertise as standard",
      ...
      "why.1": "Senior-level delivery as standard — every engineer on your project has years of production experience.",
      ...
      "team.b.name": "Luiza Rcheulishvili",
    ...
    ka: {
      ...
      "hero.lead": "KartvelOps ნერგავს, აინტეგრირებს და ემსახურება პლატფორმებს, რომლებზეც ბიზნესი დგას — CI/CD და Kubernetes-იდან ძირითადი საბანკო სისტემების დანერგვამდე. გამოცდილი ინჟინრები ყველა საქმეზე, პროექტული მიწოდება, არაფერი ზედმეტი.",
      "hero.cta1": "მოგვიყევით პროექტზე",
      "hero.cta2": "სერვისების ნახვა",
      "status.available": "ვიღებთ ახალ პროექტებს",
      "trust.1": "სენიორული დონე — ყოველ პროექტში",
      ...
      "why.1": "სენიორული დონე — სტანდარტად: თქვენს პროექტზე მომუშავე ყველა ინჟინერს წლების საწარმოო გამოცდილება აქვს.",
