...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "hero.lead": "KartvelOps implements, integrates and operates the platforms businesses depend on — from CI/CD and Kubernetes to core-banking rollouts. Senior engineers only, project-based delivery, nothing you don't need.",
    ...
    ka: {
      ...
      "hero.lead": "KartvelOps ნერგავს, აინტეგრირებს და ემსახურება პლატფორმებს, რომლებზეც ბიზნესი დგას — CI/CD და Kubernetes-იდან ძირითადი საბანკო სისტემების დანერგვამდე. მხოლოდ გამოცდილი ინჟინრები, პროექტული მიწოდება, არაფერი ზედმეტი.",
